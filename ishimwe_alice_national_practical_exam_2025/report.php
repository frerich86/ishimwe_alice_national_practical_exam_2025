        ...
        <div class="form-control">
            ...
            <table border=1 align=center width=100%>
                ...
                <tr>
                    ...
                    // $query=mysqli_query($con,"select * from students,courses,attendance where students.StudentId=attendance.StudentId and courses.CourseId=attendance.CourseId and grou");
                    // group by date of today
                    $query=mysqli_query($con,"select * from students,courses,attendance where 
                    students.StudentId=attendance.StudentId and courses.CourseId=attendance.CourseId and 
